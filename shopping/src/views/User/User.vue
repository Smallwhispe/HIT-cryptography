<template>
  <el-container class="home_container">
    <el-header class="home_header">
      <div class="home_title">拼夕夕-用户</div>
    ...
    <el-container>
      ...
      <el-aside class="home_aside" width="200px">
        ...
        <el-menu router>
          <el-menu-item index="/browse" :class="$route.path=='/browse'?'is-active':''">
            <i class="el-icon-s-order"></i>
            <span slot="title">商品浏览</span>
          </el-menu-item>

          <el-menu-item index="/cart" :class="$route.path=='/cart'?'is-active':''">
